...
*   M= parameter acts as digital switch (M=0 disconnects, M=1 connects)
*   All caps placed with matched routing to CK_OUT (equal parasitic per bit)
CC_sk0  CK_OUT VSS  1.0f  $[MOMCAP_7nm_M4_M7] M='SKEW0?1:0'  $  +8 ps (LSB)
CC_sk1  CK_OUT VSS  2.0f  $[MOMCAP_7nm_M4_M7] M='SKEW1?1:0'  $ +16 ps
CC_sk2  CK_OUT VSS  4.0f  $[MOMCAP_7nm_M4_M7] M='SKEW2?1:0'  $ +32 ps
CC_sk3  CK_OUT VSS  8.0f  $[MOMCAP_7nm_M4_M7] M='SKEW3?1:0'  $ +64 ps  $[FIX3-v6]: new
CC_sk4  CK_OUT VSS 16.0f  $[MOMCAP_7nm_M4_M7] M='SKEW4?1:0'  $+128 ps  $[FIX3-v6]: new, MSB
.ENDS
