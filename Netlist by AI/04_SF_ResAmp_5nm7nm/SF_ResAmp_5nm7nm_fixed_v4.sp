...
MM_mcas  net_rs VBIAS  VSS     VSS NMOS_7nm_IO W=1188n L=14n NFIN=12 M=1  $[ENH2-v4]: NFIN 6->12, M=2->1; 2x Weff, halved Vov
MM_pref  IBIAS_P IBIAS_P VDD  VDD PMOS_7nm_IO W=594n L=14n NFIN=6  M=2
MM_pcas  net_rp  IBIAS_P net_rp  VDD PMOS_7nm_IO W=1188n L=14n NFIN=12 M=1  $[ENH2-v4]: NFIN 6->12, M=2->1; 2x Weff, halved Vov
* Startup cell
